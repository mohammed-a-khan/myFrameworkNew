...
public class CSBDDRunner extends CSBaseTest {
    ...
    public void teardownBDDRunner() {
        ...
        // Quit the driver for this thread to ensure cleanup
        // This is important when browser.reuse.instance=true
        if (driver != null) {
            logger.info("[{}] Closing browser in @AfterClass", threadName);
