...
public class ForceCustomReportTest {
    
    @Test
    public void generateCustomReportsWithScreenshotButtons() {
        try {
            ...
            // Add 4 failing tests (as shown in recent report) with screenshots
            String[] failedTests = {
            ...
            for (int i = 0; i < failedTests.length; i++) {
                ...
                String screenshotBase64 = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mNkYGAAAAABAAFKxtUrAAAAAElFTkSuQmCC";
            ...
            if (!foundCustomReport) {
                System.out.println("❌ Custom report generation failed - checking alternative locations...");
                // Check cs-reports directory
                File csReports = new File("cs-reports");
                if (csReports.exists()) {
                    System.out.println("cs-reports directory contents:");
            ...
            System.out.println("❌ TestNG Report (emailable-report.html): NO screenshot buttons at all");
            System.out.println("✅ Custom Report (cs_test_run_report.html): HAS screenshot buttons with working images");
            System.out.println("");
            System.out.println("👆 YOU NEED TO USE THE CUSTOM REPORT ABOVE, NOT THE TESTNG REPORT!");
